...
router.post('/categoria', authenticateToken, CategoriaController.createCategoria);
router.put('/categoria/:produto_id', authenticateToken, CategoriaController.updateCategoria);
router.delete('/categoria/:produto_id', authenticateToken, CategoriaController.deleteCategoria);
